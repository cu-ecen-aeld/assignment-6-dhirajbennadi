...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-dhirajbennadi;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
SRCREV = "cea8033d0b0d5175aae6800d5e9d4babca53709f"
...
FILES_${PN} += "${bindir}/aesdsocket-start-stop.sh "
